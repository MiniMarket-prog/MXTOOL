...
export default function OverviewPage() {
  ...
  const systemHealth = hasApiKeys && configuredProviders > 0 ? 100 : hasApiKeys ? 75 : 25
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-700 text-sm">
                        Add your MXToolbox API keys to start checking IP addresses. Currently using {totalKeys}{" "}
                        environment keys.
                      </p>
                    </div>
                  </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-orange-200 mt-1">{hasApiKeys ? "Ready" : "Setup needed"}</p>
                </div>
